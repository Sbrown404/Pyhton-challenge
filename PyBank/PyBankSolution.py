# Create a Python code for PyBank Challenge
...
# Create The total number of months included 
...
# Create a text file
budget_data = os.path.join("Output", "budget_data.txt")
with open(budget_data.txt, "w") as outfile:
